...
{
  question: "医薬部外品の製造販売業許可を取得するために必要な管理者は？",
  choices: [
    "製造管理者と品質管理者",
    "医師",
    "販売士",
...
{
  question: "医薬部外品の製造販売業許可を更新する際に必要なことは？",
  choices: [
    "有効期間満了前に更新申請を行う",
    "新しい商品を発売する",
    "従業員全員の資格を取得する",
...
{
  question: "医薬部外品の製造販売業許可を持つ会社が守るべき主な法律は？",
  choices: [
    "医薬品医療機器等法（薬機法）",
    "道路交通法",
    "労働基準法",
...
{
  question: "医薬部外品の製造販売業許可を持つ会社が行うべき品質管理の内容は？",
  choices: [
    "製品の安全性や有効性の確認",
    "商品のデザイン変更",
    "販売価格の決定",
...
{
  question: "医薬部外品の製造販売業許可を持たずに販売した場合の罰則は？",
  choices: [
    "懲役や罰金などの刑事罰",
    "特に罰則はない",
    "広告ができなくなるだけ",
...
{
  question: "医薬部外品の製造販売業許可を取得するために必要なものは？",
  choices: [
    "所定の申請書と必要書類の提出",
    "医師免許",
    "販売士資格",
...
{
  question: "医薬部外品の製造販売業許可を出すのはどこですか？",
  choices: [
    "厚生労働省",
    "都道府県知事",
    "経済産業省",
...
{
  question: "医薬部外品の製造販売業許可が必要となるのはどんな場合？",
  choices: [
    "医薬部外品を製造または販売する場合",
    "広告を作成する場合",
    "従業員を雇う場合",
...
{
  question: "医薬部外品の製造販売業許可の有効期間は原則何年ですか？",
  choices: [
    "1年",
    "3年",
    "5年",
...
{
  question: "医薬部外品の製造販売業許可を持たずに販売した場合どうなる？",
  choices: [
    "法律違反となり罰則を受ける",
    "特に問題ない",
    "消費者庁に報告するだけでよい",
